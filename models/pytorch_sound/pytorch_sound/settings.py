...
from models.pytorch_sound.pytorch_sound.data.eng_handler.symbols import symbols as eng_symbols
from models.pytorch_sound.pytorch_sound.data.korean import PHONEMES as kor_phonemes, GRAPHEMES as kor_graphemes
from typing import List, Dict

#
# AUDIO, STFT parameters
#
SAMPLE_RATE: int = 16000  # sample rate of target wave
N_FFT: int = 1024
